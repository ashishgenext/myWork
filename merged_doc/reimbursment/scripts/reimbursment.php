...
$query = "INSERT INTO reimbursment (name,designation,employee_id,school_or_office,patient_name,patient_age,relation, request_id, email_id) VALUES ( '$name', '$designation', '$employee_no', '$school_office','$name_patient','$age', '$relation', '$reimbursmentRequestId', '$email')";
