...
$comment =$_GET['comment'];
echo $request_id, $approve, $discard;
if($_GET['approve'])
{
	$status = "approved";
}
...
$query = "UPDATE reimbursment SET status='$status', comment='$comment' where request_id='$request_id'";
...
if (mysql_query($query))
{
	...
	$mail->AltBody = 'Your reimbusment have been '.$status. ' which has reimbursment id: '. $request_id;
