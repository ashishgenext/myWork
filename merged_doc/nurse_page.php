 ...
 <form method="post" action="">
              ...
              <div id="right">
                <div id="sidebar">
                  ...
                  <ul class="vmenu">
                    <li>
                      <a href="biomedical.php" shape="rect">Insert Bio Medical Waste Data</a>
                    </li>
                     <li>
                      <a href="search_waste.php" shape="rect">Search waste record</a>
                    </li>
					<li>
                      <a href="search_patient.html" shape="rect">Search Patients</a>
                    </li>
                    <li>
                    <a href="drugTable.php" shape="rect">Available Drugs</a>
                    </li>
					 <li>
                    <a href="nurse_personal_detail.php" shape="rect">Edit Personal Details</a>
                    </li>
